...
class Form
{
    ...
    */
    private function getErrorMessage($rule, $parameter = null)
    {
        $language = [
            ...
            'required' => ' You are required to enter a note',
            'email' => ' is not a valid email address.',
            'min' => ' has to be greater than '.$parameter,
            'max' => ' has to be less than '.$parameter,
            'musicalNote' => ' Please enter a valid musical note'
        ];
    ...
    */
    ...
    private function musicalNote($value)
    {
        $noteValues = ['c' => 0, 'd' => 2, 'e' => 4, 'f' => 5, 'g' => 7, 'a' => 9, 'b'=>11];
        $validNote = array_key_exists(strtolower($value), $noteValues);
            return $validNote;
    }
